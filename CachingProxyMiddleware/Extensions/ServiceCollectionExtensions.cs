...
public static class ServiceCollectionExtensions
{
    public static IServiceCollection AddMediaCache(this IServiceCollection services, IConfiguration configuration)
    {
        ...
        {
            var options = configuration.GetSection(MediaCacheOptions.SectionName).Get<MediaCacheOptions>() ?? new MediaCacheOptions();
    ...
    public static IServiceCollection AddMediaCache<TUrlResolver>(this IServiceCollection services, IConfiguration configuration)
